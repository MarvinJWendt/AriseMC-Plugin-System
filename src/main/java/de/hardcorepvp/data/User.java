...
public class User extends DatabaseUpdate {
	...
	public void addHome(String name, Location location) {
		...
		this.writeToDatabase(false,true, false, false);
	}
	...
	public void addMoney(long money) {
		this.money += money;
		this.writeToDatabase(false,false, true, false);
	}
	...
	public void addKill() {
		this.kills++;
		this.writeToDatabase(false,false, false, true);
	}
	...
	private void writeToDatabase(boolean group, boolean homes, boolean money, boolean stats) {
		Bukkit.getScheduler().runTaskAsynchronously(Main.getInstance(), () -> {
			try {
