...
public class UserManager {
	...
	private void setupTables() {
		try {
			...
			PreparedStatement statement2 = Main.getDatabaseManager().getConnection().prepareStatement("CREATE TABLE " + "IF" + " NOT EXISTS" + " " +
					"`user_homes` (" + " `uniqueId` CHAR(36) NOT NULL," + " `name` VARCHAR(50) NOT" + " " + "NULL," + " `location` VARCHAR(50) NOT NULL," + " "
