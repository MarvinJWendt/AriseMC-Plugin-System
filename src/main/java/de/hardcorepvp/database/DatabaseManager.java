...
public class DatabaseManager {
    ...
    private void setupTables() {
        try {
            ...
            PreparedStatement statement = this.connection.prepareStatement("CREATE TABLE IF NOT EXISTS `user_money` (" +
            ...
            PreparedStatement statement1 = this.connection.prepareStatement("CREATE TABLE IF NOT EXISTS `user_stats` (" +
                    "  `id` INT NOT NULL AUTO_INCREMENT," +
                    "  `uniqueId` CHAR(36) NOT NULL," +
            ...
            PreparedStatement statement2 = this.connection.prepareStatement("CREATE TABLE IF NOT EXISTS `user_homes` (" +
                    "  `uniqueId` CHAR(36) NOT NULL," +
